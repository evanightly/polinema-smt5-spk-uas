<script>
	import { Key, Scale, TableCells } from '@inqling/svelte-icons/heroicon-24-outline';
	import '../app.css';
</script>
	...
	>
		...
		>
			<div class="mr-5 lg:mr-0 lg:hidden">
				<a class="flex-none text-xl font-semibold dark:text-white" href="#test" aria-label="Brand"
					>DSS</a
				>
			</div>
			...
			>
				...
				<div class="hidden sm:flex dark:text-gray-400">
					<label for="study_case_input">Studi Kasus</label>
					<select
						name="study_case"
						id="study_case_input"
						class="py-2 px-4 block w-full border-gray-200 shadow-sm rounded-md text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400"
					>
						<option value="1">Recruitment Pegawai</option>
						<option value="0" class="text-green-500"> Tambah Studi Kasus</option>
					</select>
				</div>
