<script lang="ts">
	...
	import Topsisv2 from '$lib/methods/topsisv2.svelte';
	...
	const methods = ['Topsis', 'Topsis V2', 'PSI', 'Vikor', 'Moora', 'Waspas', 'Smart'];
...
{#if calculationType}
	{#if calculationType === 'Topsis'}
		<Topsis />
	{:else if calculationType === 'Topsis V2'}
		<Topsisv2 />
